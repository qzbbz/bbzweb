...
public class WeixinMenuManager {
	...
	public static void main(String[] args) {
		...
		String accessToken = "CStB1LMyIWmq_kQHPOU9ecP0AFbEbzslmbDk8Q6ZXHHGU87OD6kWv9TTDwczb9gjqPhFdI7SuKp3YFUEtoUSfpe1ghDm8-PeVk0eT2Hqhfg";
