	...
	public long addCompanyBill(CompanyBill companyBill) {
		...
		jdbcTemplate.update(new PreparedStatementCreator() {  
	        public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {  
	        	String sql = "insert into company_bill (company_id, file_name, create_time)"
	    				+ " values (?, ?, ?)";
	               ...
	               ps.setTimestamp(3, companyBill.getCreateTime() == null ? new Timestamp(System.currentTimeMillis()) : companyBill.getCreateTime());
	               return ps;  
	        }  
	    }, keyHolder);
